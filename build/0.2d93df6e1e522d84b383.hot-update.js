...
/***/ function(module, exports, __webpack_require__) {
	...
	var rscale = function rscale(a, b, c) {
	  ...
	  return "M" + [a, b, c].map(function (t) {
	    var v = t[0] === 0 || t[1] === 0 || t[0] === tiles || t[1] === tiles ? 0 : _.random(0, 30);
	    if (!rmap['' + t]) {
	...
	var cscale = chroma.scale([colors[1], colors[3]]).colors(tiles * 2);
	...
	var animate = function animate() {
	  ...
	  var cscale = chroma.scale([brew[7][2], _.last(brew[7])]).colors(tiles * 20);
